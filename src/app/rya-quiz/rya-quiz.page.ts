...
@Component({
  selector: 'app-rya-quiz',
  templateUrl: './rya-quiz.page.html',
  styleUrls: ['./rya-quiz.page.scss'],
})
export class RyaQuizPage implements OnInit {
  ...
  ngOnInit() {
    this.getData.getAllData().subscribe(data => {
      ...
      this.a = this.characters.slice(89, 92);
      this.list = [this.a[0]];
      this.loaded = true;
    });
  }
