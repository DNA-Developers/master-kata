...
@Component({
  selector: 'app-hya-quiz',
  templateUrl: './hya-quiz.page.html',
  styleUrls: ['./hya-quiz.page.scss'],
})
export class HyaQuizPage implements OnInit {
  ...
  ngOnInit() {
    this.getData.getAllData().subscribe(data => {
      ...
      this.a = this.characters.slice(98, 101);
      this.list = [this.a[0]];
      this.loaded = true;
    });
  }
