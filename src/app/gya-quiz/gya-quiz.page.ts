...
@Component({
  selector: 'app-gya-quiz',
  templateUrl: './gya-quiz.page.html',
  styleUrls: ['./gya-quiz.page.scss'],
})
export class GyaQuizPage implements OnInit {
  ...
  ngOnInit() {
    this.getData.getAllData().subscribe(data => {
      ...
      this.a = this.characters.slice(92, 95);
      this.list = [this.a[0]];
      this.loaded = true;
    });
  }
