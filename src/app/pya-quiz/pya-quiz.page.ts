...
@Component({
  selector: 'app-pya-quiz',
  templateUrl: './pya-quiz.page.html',
  styleUrls: ['./pya-quiz.page.scss'],
})
export class PyaQuizPage implements OnInit {
  ...
  ngOnInit() {
    this.getData.getAllData().subscribe(data => {
      ...
      this.a = this.characters.slice(101, 104);
      this.list = [this.a[0]];
      this.loaded = true;
    });
  }
