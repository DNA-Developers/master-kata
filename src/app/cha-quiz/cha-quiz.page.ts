...
@Component({
  selector: 'app-cha-quiz',
  templateUrl: './cha-quiz.page.html',
  styleUrls: ['./cha-quiz.page.scss'],
})
export class ChaQuizPage implements OnInit {
  ...
  ngOnInit() {
    this.getData.getAllData().subscribe(data => {
      ...
      this.a = this.characters.slice(77, 80);
      this.list = [this.a[0]];
      this.loaded = true;
    });
  }
