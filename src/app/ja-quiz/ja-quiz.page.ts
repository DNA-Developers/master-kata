...
@Component({
  selector: 'app-ja-quiz',
  templateUrl: './ja-quiz.page.html',
  styleUrls: ['./ja-quiz.page.scss'],
})
export class JaQuizPage implements OnInit {
  ...
  ngOnInit() {
    this.getData.getAllData().subscribe(data => {
      ...
      this.a = this.characters.slice(95, 98);
      this.list = [this.a[0]];
      this.loaded = true;
    });
  }
